		...
		textRef = data.text.toString();
			...
			//	console.log(competenciaValue);
				...
				var aguaservRef = aguaValue.replace('.', '');
          		...
          		if (competenciaValue== 'Dez/21' || competenciaValue == '0,000,' || distancia <=-65 ||  anocompetencia<anoparcela || (mescompetenciaRevisado<mesparcela && anocompetencia==anoparcela ))
          		{
...

          		{
          			...
          			//console.log("Ano é 2019");
          				...
          				//console.log ("Mês é 8 ou 9, isso tem que ser variavel depois com o mês atual");
          					...
          					console.log(distancia);
          					console.log(competenciaValue);*/
          					console.log("Pago em 2022");
          					} else if(dia>=1)
          					{
          						if (competenciaValue== 'Nov/21')
          						{
          							if (dia>grupoRef+9)
          							{
          								valortotal = valortotal+totalRef;
