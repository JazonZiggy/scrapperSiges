		...
		textRef = data.text.toString();
			...
			//	console.log(competenciaValue);
				...
				var aguaservRef = aguaValue.replace('.', '');
          		...
          		if (competenciaValue == "Abr/21" || competenciaValue == "Mar/21" ||competenciaValue == "Dez/20" || competenciaValue == "Jan/21" ||competenciaValue == "Fev/21" || competenciaValue == "Nov/20" ||competenciaValue == "Out/20" || competenciaValue=='Set/20'|| competenciaValue== 'Ago/20' || competenciaValue== 'Jul/20' ||competenciaValue== 'Jun/20' ||competenciaValue== 'Mai/20' ||competenciaValue== 'Abr/20' ||competenciaValue== 'Mar/20' || competenciaValue == '0,000,' || distancia <=-65 ||  anocompetencia<anoparcela || (mescompetenciaRevisado<mesparcela))
          		{
